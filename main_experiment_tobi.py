...
import csv
import random
from parameter_list_tobi import *
...
def writeData(datalist, subID):
    ...
    w = csv.writer(open("./Data/Sub{}.csv".format(subID), "w"))
    w.writerow(['SubjectID','StimulusType','response','RT'])
...
if __name__ == "__main__":
    ...
    subID = "201904150051" # TODO ID of the subject
